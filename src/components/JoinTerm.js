    ...
    <div className="joinmain">
      ...
      <div div className="join">
        <form action="#" className="joinform">
          ...
          <div className="term1">
            <p>제 1 장 총 칙</p>
            <p>제 1 조 (목적)<br/>이 약관은 개발하는 커비(이하 "사이트"라 합니다)에서 제공하는 인터넷서비스(이하 "서비스"라 합니다)의 이용 조건 및 절차에 관한 기본적인 사항을 규정함을 목적으로 합니다.</p>
          ...
          {!buttonOn && <button className="regchkbtnf">다음</button>}
          {buttonOn && <button className="regchkbtnt">다음</button>}
        </form>
      </div>
    </div>
  );
